...
parser.add_argument('-d', '--data_dir', default="/home/jupyter/object-detection/Mask_RCNN/samples/buccin/dataset/", type=str,help='directory containing annotation file')
parser.add_argument('-i', '--image_dir', default="/home/jupyter/object-detection/Mask_RCNN/samples/buccin/dataset/mission2", type=str,help='directory containing images')
parser.add_argument('-o', '--output_dir', default="/home/jupyter/object-detection/Mask_RCNN/samples/buccin/dataset/", type=str,help='directory containing images')
...
train_folder = os.path.join(input_dir,'train')
...
val_folder = os.path.join(input_dir,'val')
