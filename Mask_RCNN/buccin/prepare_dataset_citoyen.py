...
parser.add_argument('-o', '--output_dir', default="/home/jupyter/object-detection/Mask_RCNN/samples/buccin/dataset/", type=str,help='output directory to store the dataset')
